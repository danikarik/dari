...
func testUserToManyOffers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadOffers(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyPricelists(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadPricelists(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRegistryJournals(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadRegistryJournals(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpOffers(t *testing.T) {
	var err error
...
func testUserToManySetOpOffers(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpOffers(t *testing.T) {
	var err error
...
func testUserToManyAddOpPricelists(t *testing.T) {
	var err error
...
func testUserToManyAddOpRegistryJournals(t *testing.T) {
	var err error
...
func testUserToManySetOpRegistryJournals(t *testing.T) {
	var err error
	...
	err = a.SetRegistryJournals(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetRegistryJournals(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.RegistryJournals[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.RegistryJournals[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testUserToManyRemoveOpRegistryJournals(t *testing.T) {
	var err error
	...
	err = a.AddRegistryJournals(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveRegistryJournals(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.RegistryJournals) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.RegistryJournals[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.RegistryJournals[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}
...
var (
	userDBTypes = map[string]string{`CreatedAt`: `timestamp`, `Email`: `varchar`, `ID`: `int`, `Name`: `varchar`, `Options`: `json`, `Password`: `varchar`, `RememberToken`: `varchar`, `RoleID`: `int`, `UpdatedAt`: `timestamp`}
	_           = bytes.MinRead
)
